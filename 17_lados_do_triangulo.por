programa {
  funcao inicio() {
    ...
    se(x + z > y e x + y > z e z + y > x){
      escreva("O triangulo com os lados ", x, " ", y, " ", z, " ", " existe, pois o lado y e menor que a soma de x + z = ", x + z, " e o lado z e menor que a soma de x + y = ", x + y)
    }
    senao se(nao x + z > y e x + y > z){
      escreva("O triangulo com os lados ", x, " ", y , " ", z, " nao existe, pois o lado y e maior que a soma de x + z ", x+z)
    } senao se(x + z > y e (nao (x + y > z))){
